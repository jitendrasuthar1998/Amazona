...
export const orderDeliverReducer = ( state = {}, action ) => {
  switch(action.type){
    ...
    case ORDER_DETAILS_SUCCESS:
      return { loadingDeliver: false, successDeliver: true };

    case ORDER_DELIVER_FAIL:
      return { loadingDeliver: false, errorDeliver: action.payload };
